...
var CdkDialogContainer = class _CdkDialogContainer extends BasePortalOutlet {
  ...
  _portalOutlet;
  _focusTrapped = new import_rxjs3.Subject();
...
var DialogRef = class {
  ...
  closed = new import_rxjs3.Subject();
...
var Dialog = class _Dialog {
  ...
  _afterAllClosedAtThisLevel = new import_rxjs3.Subject();
  _afterOpenedAtThisLevel = new import_rxjs3.Subject();
   ...
   */
  afterAllClosed = (0, import_rxjs3.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators3.startWith)(void 0)));
  constructor() {
  }
...
var MatDialogRef = class {
  ...
  constructor(_ref, _config, _containerInstance) {
    ...
    (0, import_rxjs5.merge)(this.backdropClick(), this.keydownEvents().pipe((0, import_operators5.filter)((event) => event.keyCode === ESCAPE && !this.disableClose && !hasModifierKey(event)))).subscribe((event) => {
...
var MatDialog = class _MatDialog {
   ...
   * Will emit on subscribe if there are no open dialogs to begin with.
   */
  afterAllClosed = (0, import_rxjs5.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators5.startWith)(void 0)));
  constructor() {
